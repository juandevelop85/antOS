...
| **Fase 20** | [T20.1](T20.1-espacio-de-trabajo-integrado-dev-tui-con-neovim-monitor-de-agentes-y-visor-de-diffs.md) | Espacio de Trabajo Integrado Dev TUI con Neovim, Monitor de Agentes y Visor de Diffs | ⏳ Pendiente |
