...
| **Fase 18** | [T18.1](T18.1-abstraccion-de-capa-de-hardware-hal-y-desacoplamiento-de-arquitectura-en-kernel.md) | Abstracción de Capa de Hardware (HAL) y Desacoplamiento de Arquitectura en Kernel | ⏳ Pendiente |
