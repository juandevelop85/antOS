...
impl NvmeController {
    ...
    pub fn init(
        ...
        let mut controller = NvmeController {
            ...
            doorbell_stride,
            asq_phys,
            asq_virt: asq_v as *mut NvmeCmd,
            asq_tail: 0,
            acq_phys,
            acq_virt: acq_v as *mut NvmeCqe,
            acq_head: 0,
            acq_phase: 1, // Phase starts at 1
            iosq_phys,
            iosq_virt: iosq_v as *mut NvmeCmd,
            iosq_tail: 0,
            iocq_phys,
            iocq_virt: iocq_v as *mut NvmeCqe,
            iocq_head: 0,
            iocq_phase: 1,
            dma_buf_phys,
            dma_buf_virt: dma_buf_v as *mut u8,
            command_id: 0,
            namespaces: Vec::new(),
        };
